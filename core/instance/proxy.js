import { updateNode } from "./rendernode.js";
import { template2vnode } from "./render.js";
import { rebulid } from "./mount.js";
        ...
        for(let prop in obj){
           ...
           */
            ...
            if(obj[prop] instanceof Object ){
                proxyObj[prop] = constructorData(vm ,obj[prop] , getNameSpace(namespace,prop));
            }
        }
        return proxyObj;
    }
        ...
        Object.defineProperty(obj,type,{
            ...
            value:(function(){
                return function (...arg){
                    ...
                    rebulid( vm , getNameSpace(namespace,''));/* 在调用数组方法时候需要重构节点 */
                    updateNode( vm , getNameSpace(namespace,''));
                    return result;
                }
            }())
        })
